...
const KidsDemo = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/products/category/kids%20ware")  // Replace with your API endpoint
      .then((response) => {
  ...
  return (
    <div>
<h1 className="text-center">Kids's Wear</h1>
<div className="product-list" style={{minHeight:'80vh'}}>
      ...
      {limitedProducts.map((product) => (
        ...
        <div className="product-card arrow-mark" onClick={()=>navigate("/products/category/kidswear")}>
